...
Para testar o Littlebot em seu sistema você precisa ter instalado o ROS ([kinetic](http://wiki.ros.org/kinetic) recomendado). Um erro pode acontecer ao tentar vizualizar o modelo no RVIZ caso isso ocorra pode ser necessário mudar uma variável de ambiente, como segue abaixo:
